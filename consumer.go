...
// NewConsumer initalizes a new consumer struct with the given cluster client, group and topics.
// Once the consumer is initialized is it not plausible to add more topics to the consumer.
